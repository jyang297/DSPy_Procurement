...
class RequirementSpecification(dspy.Signature):
    ...
    item_category: str = dspy.OutputField(
        desc="The category of the item or service being procured."
    )
    key_specifications: list[str] = dspy.OutputField(
        desc="The key specifications or features required."
    )
    ...
    required_delivery_date: str = dspy.OutputField(
        desc="The required delivery date for the item or service."
    )
